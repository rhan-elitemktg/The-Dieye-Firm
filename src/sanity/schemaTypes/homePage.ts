...
import { capButton, capCardTitle, capEyebrow, capFigure, capHeading, capHeadingAccent } from "./limits";
  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "ctaLabel", title: "Button label", type: "string", validation: (rule) => capButton(rule.required()) }),
      ],
    }),
    defineField({
      name: "practiceAreas",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "tileTitle", title: "Photo tile — title", type: "string", validation: (rule) => capCardTitle(rule.required()) }),
